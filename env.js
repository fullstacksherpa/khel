 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.khel.app.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.khel.app'; // ios bundle id
const PACKAGE = 'com.khel.app'; // android package name
